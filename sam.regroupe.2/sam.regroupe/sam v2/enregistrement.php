    ...
    <div class="row ">
        ...
        <div class="col-6">
           ...
           <div class="card card-outline-secondary">
                ...
                <div class="fromgroup">
                    <label>Autre période: </label> <input type="date" id="date_regelement" /><br />
                </div>
                </div>
            </div>
        </div>                           
...
else //On est dans le cas traitement
{
    //On charge la bonne base de donnée
                            ...
                            if ($_POST['Groupe']=='1') {
                                    $_SESSION['db_id'] = '1';
                                    $_SESSION['db'] = 'c1sam'; // nom de la base de donnée
                            }
                            
                            else if ($_POST['Groupe']=='2') {
                                $_SESSION['db_id'] = '2';
                                    $_SESSION['db'] = 'c2sam'; // nom de la base de donnée
                            }
                            
                            else if ($_POST['Groupe']=='3') {
                                $_SESSION['db_id'] = '3';
                                    $_SESSION['db'] = 'c3sam'; // nom de la base de donnée
                            }
    ...
    else $parking = $_POST['parking'];

    if(empty($_POST['duree'])){
        $erreur_enreg .="Durée de renouvellement<br/>";
        $i_errors++;
    } 
    else  $duree = $_POST['duree'];
    if(empty($_POST['reglement'])){
        $erreur_enreg .="Modalité de régelement<br/>";
        $i_errors++;
    }   
    else $reglement = $_POST['reglement'];
    ...
    if($i_errors==0){
        ...
        if(!$mail_free)
        {
            $erreur_enreg_2 = "Votre adresse email est déjà utilisée par un membre<br/>";
            $i++;
        }
