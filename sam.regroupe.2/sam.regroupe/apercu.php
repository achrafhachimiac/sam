...
/*
      ...
      ${'x'.$i}="x";
       ...
       if ($_POST['prestation'. $i]=="Nettoyage Studio -25m²") {
         ${'prixprestation'. $i}=45;
       }
       elseif ($_POST['prestation'. $i]=="Nettoyage APPT -35m²") {
         ${'prixprestation'. $i}=55;       
       }
       ...
       elseif ($_POST['prestation'. $i]=="PROTECTION MATELAS JETABLE IMPERMEABLE") {
         ${'prixprestation'. $i}=3;
       }
...
.$quantite88.$_POST['prestation8'].$inclu8."<br>
       ...
       .$prixprestation8.$x8.$quantite88.$inclu8."<br>Total:"
       .$total2."€
...
<form method="post" action="confirmation_de_sejour.php">
    ...
    <input type="HIDDEN" value="<?php echo($_POST['mail2']);?>" name="mail2">
    ...
    <input type="HIDDEN" value="<?php echo($_POST['choix1']);?>" name="choix1">
    <input type="HIDDEN" value="<?php echo($_POST['choix2']);?>" name="choix2">
    <input type="HIDDEN" value="<?php echo($_POST['date_solde']);?>" name="date_solde">
