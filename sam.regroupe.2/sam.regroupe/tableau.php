...
<table>
 ...
 <optgroup label="Nettoyage">        
  <option value="">--</option>  
  <option value="Nettoyage Studio -25m²">Nettoyage Studio -25m²</option>     
 ...
 <optgroup label="Locations">       
  ...
  <option value="COUETTE simple">COUETTE simple</option>        
  <option value="COUETTE double">COUETTE double</option>
  <option value="KIT BEBE">KIT BEBE</option>
   <option value="LIT BEBE">LIT BEBE</option>
 ...
 <optgroup label="Ventes annexes">        
  ...
  <option value="PROTECTION MATELAS JETABLE IMPERMEABLE">PROTECTION MATELAS JETABLE IMPERMEABLE</option>     
 </optgroup>   
</select>
       ...
       <script type="text/javascript">
          ...
          if (valeur =="Nettoyage Studio -25m²") {
            prix=45;
          }

          else if (valeur =="Nettoyage APPT -35m²") {
         prix=55;       
       }
       ...
       else if (valeur =="PROTECTION MATELAS JETABLE IMPERMEABLE") {
         prix=3;
       }
