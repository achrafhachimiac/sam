...
<div id="main-wrapperb">
	<div id="main" class="container">
		<div class="row">
			...
			if (empty($_POST['Type_presta']) or $doublon_date==1) // Si  la variable est vide, on peut considérer qu'on est sur la page de formulaire
			{ ?>

			<form class="form-horizontal formulaire_mdp" method="post" action="proprio_resa.php" enctype="multipart/form-data" id="formulaire_mdp">
				<div id="div_cmd_1" class="div_cmd_1">
					...
					<div class="row">
						...
						<div class="col-12" id="From_contour">
								...
								<!--<div id="owl-demo" class="owl-carousel owl-theme">-->
									...
									<div class="col-3 item">
										...
										<div class="div_cmd_legend">
											<label for="drap_1">Drap simple</label><input type="number" value="0"  min="0" name="drap_1" id="drap_1" data-prix="10"/>
										</div>
									</div>
									...
									<div class="col-3 item">
										...
										<div class="div_cmd_legend">
											<label for="drap_1">Drap double</label><input type="number" value="0" min="0" name="drap_2" id="drap_2" data-prix="12"/>
										</div>
									</div>
									...
									<div class="col-3 item">
											...
											<div class="div_cmd_legend">
												<label for="couette_1">Couette simple</label><input type="number" value="0"  min="0" name="couette_1" id="couette_1" data-prix="13"/>
											</div>
									</div>
									...
									<div class="col-3 item">
											...
											<div class="div_cmd_legend">
												<label for="couette_2">Couette double</label><input type="number" value="0" min="0" name="couette_2" id="couette_2" data-prix="16"/>
											</div>
							...
							<div class="row">
								<div class="col-3 item">
										...
										<div class="div_cmd_legend">
											<label for="kit_bebe">Kit bebe </label><br />	<input type="number" value="0"  min="0" name="kit_bebe" id="kit_bebe" data-prix="35"/>
										</div>
								</div>
								...
								<div class="col-3 item">
										...
										<div class="div_cmd_legend">
											<label for="lit_bebe">Lit pour bebe</label><input type="number" value="0"  min="0" name="lit_bebe" id="lit_bebe" data-prix="12"/>
										</div>
								...
								<div class="col-3 item">
										...
										<div class="div_cmd_legend">
											<label for="serviette">Serviette</label><input type="number" value="0" min="0" name="serviette" id="serviette" data-prix="6"/>
										</div>
								...
								<div class="col-3 item">
										...
										<div class="div_cmd_legend">
											<label for="serviette_piscine">Serviette piscine</label><input type="number" value="0" min="0" name="serviette_piscine" id="serviette_piscine" data-prix="4"/>
										</div>
							...
							<div class="row">
								...
								<div class="col-3 item">
										...
										<div class="div_cmd_legend">
											<label for="tapis_bain">Tapis de bain</label><input type="number" value="0"  min="0" name="tapis_bain" id="tapis_bain" data-prix="2" />
										</div>
								...
								<div class="col-3 item">
										...
										<div class="div_cmd_legend">
											<label for="torchon">Torchons (x2)</label><input type="number" value="0"  min="0" name="torchon" id="torchon" data-prix="3" />
										</div>
								...
								<div class="col-3 item">
										...
										<div class="div_cmd_legend">
											<label for="hygiene">Produit d'hygiene</label><input type="number" value="0"  min="0" name="hygiene" id="hygiene" data-prix="7" />
										</div>
								...
								<div class="col-3 item">
									...
									<div class="div_cmd_legend">
										<label for="entretien">Produit d'entretien</label><input type="number" value="0" min="0" name="entretien" id="entretien" data-prix="7" />
									</div>
								</div>
							</div>
						...
						<div class="row" id="cmd_men_fin">
							...
							<div class="col-3">
						        <div class="form-grp">
						        	<label class="custom-control custom-radio">
						     			<input type="radio" name="cmd_men_fin"  value="1" id="Oui" class="custom-control-input" />
						    ...
						    <div class="col-3">
						      	<div class="form-grp">
						      		<label class="custom-control custom-radio">
						     			<input type="radio" name="cmd_men_fin"  value="0" id="Non" class="custom-control-input" checked="checked"/>
						     			<span class="custom-control-indicator"></span>
						...
						<div class="row" id="cmd_annexe">
							...
							<div class="col-3">
						        <div class="form-grp">
						        	<label class="custom-control custom-radio">
						     			<input type="radio" name="cmd_annexe"  value="0" id="proprio" class="custom-control-input" checked="checked"/>
						     			<span class="custom-control-indicator"></span>
						    ...
						    <div class="col-3">
						      	<div class="form-grp">
						      		<label class="custom-control custom-radio">
						     			<input type="radio" name="cmd_annexe"  value="1" id="locataire" class="custom-control-input" />
						     			<span class="custom-control-indicator"></span>
						...
						<div class="row" id="cmd_fonct" style="margin-top: -5em;">
							...
							<div class="col-3">
						        <div class="form-grp">
						        	<label class="custom-control custom-radio">
						     			<input type="radio" name="cmd_fonct"  value="1" id="Deg" class="custom-control-input" />
						     			<span class="custom-control-indicator"></span>
						     			<span class="custom-control-description">Oui</span>
						     		</label>
						      	</div>
						    ...
						    <div class="col-3">
						      	<div class="form-grp">
						      		<label class="custom-control custom-radio">
						     			<input type="radio" name="cmd_fonct"  value="0" id="PasDeg" class="custom-control-input" checked="checked"/>
						     			<span class="custom-control-indicator"></span>
						     			<span class="custom-control-description">Non</span>
						     		</label>
						     	</div>
					...
					<div class="row">
						...
						<div class="col-8">
							<input type="text" name="cmd_client_tel" id="cmd_client_tel" /><br />
   						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-6">
					        <div class="form-grp">
					        	<label class="custom-control custom-radio">
					     			<input type="radio" name="mode_paiment" value="acompte" id="acompte" class="custom-control-input" />
					     			<span class="custom-control-indicator"></span>
					      	...
					      	<div class="form-grp">
					      		<label class="custom-control custom-radio">
					     			<input type="radio" name="mode_paiment" value="reglement_totale" id="reglement_totale" class="custom-control-input" checked="checked"/>
					     			<span class="custom-control-indicator"></span>
		...
		<?php }
	        ...
	        $query=$db->prepare('INSERT INTO commandes(cmd_proprio_id, cmd_debut, cmd_fin, cmd_presta, cmd_reception,  cmd_drap_1, cmd_drap_2, cmd_couette_1, cmd_couette_2, cmd_kit_bebe, cmd_lit_bebe, cmd_srv,
	        	cmd_srv_piscine, cmd_tapis_bain, cmd_torchon, cmd_hygiene, cmd_entretien, cmd_mena_fin_prix, cmd_deg, cmd_remarque, cmd_client, cmd_client_tel, cmd_paiement, cmd_annexe, cmd_date, cmd_prix) VALUES (:cmd_proprio_id, :cmd_debut, :cmd_fin, :cmd_presta, :cmd_reception, :cmd_drap_1,
	        	:cmd_drap_2, :cmd_couette_1, :cmd_couette_2, :cmd_kit_bebe, :cmd_lit_bebe, :cmd_srv,
	        	:cmd_srv_piscine, :cmd_tapis_bain, :cmd_torchon, :cmd_hygiene, :cmd_entretien, :cmd_mena_fin_prix, :cmd_deg, :cmd_remarque, :cmd_client, :cmd_client_tel, :cmd_paiement, :cmd_annexe, NOW(), :cmd_prix)');

	    $query->bindValue(':cmd_proprio_id', $proprio_id, PDO::PARAM_INT);
			...
			<div class="cmd_valide">
					...
					include("Mail_BA.php");
					?>
				<h1>Commande Validée:</h1></br>
				<p>
					Votre commande a bien été validée, Vous pouvez télécharger votre bon de commande en cliquant <?php echo'<a href=PDF/BDCn_'.$donnees_1["commande_ID"].'_GRP'. $_SESSION["db_id"].'.pdf onclick="window.open(this.href); return false;">ici</a>' ?>.<br/>
					...
					L'équipe du SAM vous remercie de vore commande.
