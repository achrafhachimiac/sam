...
$pdf->template['footer']['lineHeight'] = 10;
$pdf->template['footer']['color'] = array('r'=>100, 'g'=>100, 'b'=>100);
$pdf->template['footer']['align'] = 'L';
$pdf->template['footer']['margin'] = array(280, 20, 0, 50);
// entete de produit
$pdf->template['productHead']['fontFace'] = 'B';
$pdf->template['productHead']['color'] = array('r'=>195, 'g'=>0, 'b'=>130);
$pdf->template['productHead']['margin'] = array(40, 0, 0, 0);
$pdf->template['productHead']['padding'] = array(23, 9, 9, 14);
// liste des produit
$pdf->template['product']['fontSize'] = 10;
$pdf->template['product']['lineHeight'] = 10;
...
$pdf->template['totalHead']['margin'] = array(55, 0, 0, 0);
//$pdf->template['totalHead']['padding'] = array(28, 0, 0, 0);
// liste des totaux
$pdf->template['total']['lineHeight'] = 10;
$pdf->template['total']['margin'] = array(5, 5, 0, 5);
$pdf->template['total']['padding'] = array(0, 0, 0, 0);
// element personnalisé 1
$pdf->template['traitEnteteProduit']['lineHeight'] = 10;
...
$pdf->template['traitBas']['lineHeight'] = 10;
