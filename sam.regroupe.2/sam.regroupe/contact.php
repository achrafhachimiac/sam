...
Appartement n°: <input type="text" name=appart required/> 	Résidence : <input type="text" name=residence required/> votre adresse email : <input type="text" name=mail required/>
...
<input type="submit" value="envoyer à SAM Aussois" name="Aussois"/>
...
tel: 0479592272
							...
							<section>
								<h2 class="major"><span> Rejoignez nous </span></h2>


								Vous souhaitez un complèment de revenu ? <br>
Venez avec nous pour préparer les appartements et accueillir les vacanciers le week-end <br>
 (étudiant, retraité, temps-partiel)
