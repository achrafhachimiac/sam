						...
						<section class="menu_ident">
							...
							<div class="row justify-content-md-center">
								<div class="col-10">
									...
									veuillez entrer votre identifiant et mot de passe:</p>
								</div>
							</div> 
				...
				<div class="col-4">
						...
						if (isset($_POST['Groupe'])) {
							...
							if ($_POST['Groupe']=='1') {
									$_SESSION['db_id'] = '1';
									$_SESSION['db'] = 'c1sam';
									$db_name='c1sam'; // nom de la base de donnée
							}
							
							else if ($_POST['Groupe']=='2') {
								$_SESSION['db_id'] = '2';
									$_SESSION['db'] = 'c2sam';
									$db_name='c2sam'; // nom de la base de donnée
							}
							
							else if ($_POST['Groupe']=='3') {
								$_SESSION['db_id'] = '3';
									$_SESSION['db'] = 'c3sam';
									$db_name='c3sam'; // nom de la base de donnée
							}
					    ...
					    else if (!isset($_SESSION['pseudo'])) //On check le mot de passe
					    {
					        ...
					        if (($data['proprio_mdp'] == md5($_POST['password'])) && !isset($_SESSION['pseudo'])) // Acces OK !
					        {
