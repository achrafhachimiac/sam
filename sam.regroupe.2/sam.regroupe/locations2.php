...
<img src="capture.PNG" class="sam_titre"/>
	  ...
	  <form method="post" action="locations2.php">
...
while ($donnees = $reponse->fetch()){
	...
	<th style="border-width:1px;  border-style:solid; border-color:black; "><?php echo $donnees['nom'] ?></th>
	
	<P>


		 <?php /*<figure tabindex="1" contenteditable="true">
	...
	<th style="border-width:1px;  border-style:solid; border-color:black; ">	<?php echo$donnees['description'] ?> </th>
