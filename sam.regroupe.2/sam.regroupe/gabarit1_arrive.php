...
$pdf->template['productHead']['margin'] = array(50, 0, 0, 0);
$pdf->template['productHead']['padding'] = array(23, 9, 9, 14);
// liste des produit
$pdf->template['product']['fontSize'] = 15;
...
// liste des totaux
$pdf->template['total']['lineHeight'] = 7;
$pdf->template['total']['margin'] = array(0, 0, 0, 10);
$pdf->template['total']['padding'] = array(10, 0, 0, 0);
...
$pdf->template['traitEnteteProduit']['margin'] = array(90, 0, 0, 0);
